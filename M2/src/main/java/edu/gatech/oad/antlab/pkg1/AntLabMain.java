 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person3 p3 = new Person3("Austin");
		  toPrint += p3.toString("aspalding3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Alexandra");
                  toPrint += p4.toString("afoote8");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Chaz");
                  toPrint += p5.toString("cwoodall6");
